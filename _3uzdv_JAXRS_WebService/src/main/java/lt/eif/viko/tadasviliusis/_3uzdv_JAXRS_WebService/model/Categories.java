...
public class Categories {
     ...
     */
    @ManyToMany(targetEntity = Components.class, cascade = CascadeType.ALL)

    @JoinTable(name = "categories_components",
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && Objects.equals(categorieName, that.categorieName) && Objects.equals(components, that.components);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, categorieName, components);
    }
}
